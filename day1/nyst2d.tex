...
\quad\com{spectra the same, hence iterative convergence rates}
...
BVP for $u$ (3 lines: PDE, BC, SRC, needed for uniqueness)

Helm fund sol (pic)

pics of LPs?

  $u = \Drep \sigma$ has interior res prob (Leslie will have covered for the disk case)

  CFIE: $u = (\Drep + i\eta\Srep)\sigma$   no more unknowns, new kernel

  can prove equivalence (no spurious resonances)
