...
& \mbox{\com{jump in value; $D$ restriction in principal value sense}}
\nonumber \\
...
$D$ smooth kernel on smooth $\Gamma$, while $S$ always log-singular (weakly)
